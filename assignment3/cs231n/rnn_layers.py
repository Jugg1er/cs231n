...
def rnn_forward(x, h0, Wx, Wh, b):
    ...
    cache=[]
    for i in range(T):
        hi,cachei=rnn_step_forward(x[:,i,:],prev_h,Wx,Wh,b)
        h.append(hi)
        cache.append(cachei)
        prev_h=hi
    h=np.array(h)
...
def rnn_backward(dh, cache):
    ...
    dx,dh0,dWx,dWh,db=[],np.zeros((N,H)),np.zeros((D,H)),np.zeros((H,H)),np.zeros((H,))
...
def lstm_step_forward(x, prev_h, prev_c, Wx, Wh, b):
    ...
    cache=(i,f,o,g,ai,af,ao,ag,x,Wx,Wh,prev_h,prev_c,next_c)
    ##############################################################################
    #                               END OF YOUR CODE                             #
    ##############################################################################
...
def lstm_step_backward(dnext_h, dnext_c, cache):
    ...
    #############################################################################
    i,f,o,g,ai,af,ao,ag,x,Wx,Wh,prev_h,prev_c,next_c=cache
