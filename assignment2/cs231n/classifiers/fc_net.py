...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        A2,A2_cache=affine_forward(H1,self.params['W2'],self.params['b2'])
        scores=A2
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
...
class FullyConnectedNet(object):
    ...
    def __init__(self, hidden_dims, input_dim=3*32*32, num_classes=10,
        ...
        for i in range(len(all_dims)):
            ...
            if (self.normalization=='batchnorm' or self.normalization=='layernorm') and i<len(all_dims)-1 :
    ...
    def loss(self, X, y=None):
        ...
        for i in range(self.num_layers):
            ...
            if i==self.num_layers-1:
                ...
                if self.normalization=='batchnorm':
                    gammai=self.params['gamma'+strid]
                    betai=self.params['beta'+strid]
                    Output,cache['cache'+strid]=affine_bn_relu_forward(Input,Wi,bi,gammai,betai,self.bn_params[i])
                elif self.normalization=='layernorm':
                    gammai=self.params['gamma'+strid]
                    betai=self.params['beta'+strid]
                    Output,cache['cache'+strid]=affine_ln_relu_forward(Input,Wi,bi,gammai,betai,self.bn_params[i])
                else:
        ...
        for i in range(self.num_layers)[::-1]:
            ...
            if i==self.num_layers-1:
                ...
                if self.use_dropout:
                    dX=dropout_backward(dout,cache['dropout'+strid])
                if self.normalization=='batchnorm':
